...
<div id="minMax">
	<div id="header">
		...
		<div class="content"><br /></div><!--Scott, if you remove this line or remove the br, you duplicate the mac misalignment issue-->
	</div>
<div class="content"><br /></div><!--Scott, I added this to solve the mac issue-->
...
echo "<p>Currently, you are enrolled in the Free membership. <br><br>You can create one document goodbye message, sent out via email, and one memorial page.</p>";
}
...
echo "<p>Currently, you are enrolled in the Standard membership. You can create five document goodbye messages, sent out via email.  One document goodbye message, sent out via mail.  One video goodbye message, sent out via email and one memorial page.</p>";
}

if($_SESSION['user_level'] == 3){
echo "<p>Currently, you are enrolled in the Premium membership. You can create unlimited document goodbye messages, sent out via email.  Five document goodbye messages, sent out via mail.  Five video goodbye messages, sent out via email and two memorial pages.</p>";
}

echo "<h2><a href=\"subscriptions.php\">Upgrade Your Membership ?</a></h2>\n";
echo "<hr>\n";
...
echo "<label>State <input id=\"state\"
 name=\"state\" size=\"50\" value=\"$d22\"></label><span style=\"font-size: 11px;color:#999999;font-style:italic;\">(two letter)</span><br>\n";
...
$('#state').plum('form.verify', { min: 2, max: 2 });
