...
<i>$10.00 (UPGRADE) For Life Time</i><br> 
This is the paid premium plan.</p>

<br>Text Goodbyes via email: Unlimited
<br>Text Goodbyes via USPS Mailing: 5
<br>Video Goodbyes via: 5
<br>Memorial Page: 1

<p><a href="payment_page.php?amt=1000&pln=Premium%20Plan%20Upgrade &lev=3&gby=99&usp=5&vid=5&mem=1&exa=0&exb=0" class="large button blue">Subscribe Now</a></p>
</div>
...
<input type="button" name="test" value="Purchase Now" onClick="go()" class="large button blue">
</form>
</div>
